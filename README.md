# QuickEd [![Latest Github release](https://img.shields.io/github/release/mdoblas/quicked.svg)](https://github.com/mdoblas/quicked/releases/latest) [![Build status of dev](https://img.shields.io/cirrus/github/mdoblas/QuickEd/dev)](https://github.com/maxdoblas/QuickEd/tree/dev) [![Published](https://img.shields.io/badge/Published%20in-BioRxiv-167DA4.svg)]()
...
- **unsigned int** `window_size`: sets the window size in blocks for the WindowEd algorithms. Also, it sets the window size for the WindowEd(L) inside the QuickEd method. **Note**: the size in cells will be 64x`window_size`.
- **unsigned int** `overlap_size`: sets the overlap size in blocks for the WindowEd algorithms. Also, it sets the window size for the WindowEd(L) inside the QuickEd method. **Note**: the size in cells will be 64x`window_size`.
